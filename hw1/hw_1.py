...
class NaiveBayes:
    ...
    def top_n(self, label, n):
        ...
        """
        return sorted(self.class_word_counts[label].items(), key=lambda i: i[1], reverse= True)[:n]
    ...
    def p_word_given_label_and_alpha(self, word, label, alpha):
        ...
        """
        num =alpha*len(self.vocab)
        return (self.class_word_counts[label][word]+alpha)/(self.class_total_word_counts[label]+num)
    ...
    def log_likelihood(self, bow, label, alpha):
        ...
        likelihood=0
        for i in bow:
            likelihood+= math.log(self.p_word_given_label_and_alpha(i, label, alpha))
        return likelihood
